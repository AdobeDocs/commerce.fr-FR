...
Pour plus d’informations sur la synchronisation des données [!DNL Catalog Service], consultez le [Tableau de bord de gestion des données](https://experienceleague.adobe.com/fr/docs/commerce-admin/systems/data-transfer/data-dashboard).
