...
**Données de mise à jour** : 24 août 2026

![Nouveau](../assets/new.svg) **Prise en charge de la requête `categoryTree` sur Adobe Commerce as a Cloud Service**—La requête `categoryTree` GraphQL est désormais disponible pour [!DNL Adobe Commerce as a Cloud Service], de sorte que les storefronts peuvent résoudre les catégories par slug et effectuer le rendu des arborescences de catégories. <!-- DATA-7299 -->
...
![Nouveau ](../assets/new.svg) l’[[!DNL Data Management Dashboard]](https://experienceleague.adobe.com/en/docs/commerce-admin/systems/data-transfer/data-sync/data-dashboard) est désormais disponible pour les flux de données (recommandations de produits, recherche en direct, service de catalogue). Nécessite `catalog-service` métapaquet v3.1.0+.
...
- Pour les projets déployés sur **Adobe Commerce sur le cloud, sur site ou Adobe Commerce as a Cloud Service, consultez la documentation suivante :
  ...
  - [Guide de l’administrateur Adobe Commerce](https://experienceleague.adobe.com/en/docs/commerce-admin/user-guides/home)
  - [Guide d’Adobe Commerce as a Cloud Service](../cloud-service/overview.md)
  - [Guide d’Adobe Commerce sur Cloud](https://experienceleague.adobe.com/en/docs/commerce-on-cloud/user-guide/overview)
