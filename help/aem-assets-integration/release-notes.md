...
![Nouveau problème](../assets/new.svg)<!-- Issue ACAP-1101 --> Amélioration de la stabilité globale et des performances de traitement des événements par le biais d’appels de mise à jour de ressources par lots.
...
![Nouvel événement](../assets/new.svg)<!-- Issue ACAP-1246 --> L’administrateur Commerce comprend une liste de [!UICONTROL Sync Status] axée sur les ressources pour rechercher, filtrer, trier et passer en revue les AEM Assets synchronisées par attributs de ressource au lieu d’associations de produits. Voir [Affichage de l’état de synchronisation d’AEM Assets](get-started/sync-status.md){target=_blank}.
...
![Correction d’un problème](../assets/fix.svg)<!-- Issue ACAP-1223 --> Correction d’un problème où des ensembles en double de rôles d’image de produit s’affichaient dans l’Administration pour les produits configurables.

![Correction d’un problème](../assets/fix.svg)<!-- Issue CCSAAS-4769 --> Correction d’un problème dans `UpdateAssetImageRolesDataPatch` qui provoquait une violation de contrainte d’intégrité lors des mises à niveau ou des correctifs de données.
