...
|--- |--- |
| [Paramètres d’affichage des catégories](https://experienceleague.adobe.com/fr/docs/commerce-admin/catalog/categories/create/categories-display-settings) | Ancre - `Yes` |
| [Propriétés des attributs](https://experienceleague.adobe.com/fr/docs/commerce-admin/catalog/product-attributes/create/attribute-product-create) | [Type d’entrée du catalogue](https://experienceleague.adobe.com/fr/docs/commerce-admin/catalog/product-attributes/attributes-input-types) - `Yes/No`, `Dropdown`, `Multiple Select`, `Price`, `Visual swatch` (widget uniquement), `Text swatch` (widget uniquement) |
