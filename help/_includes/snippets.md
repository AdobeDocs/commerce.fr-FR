...
>[!NOTE]
>
>Si vous avez installé le [connecteur ](../aco-connector/overview.md) pour exporter les données du catalogue vers Adobe Commerce Optimizer, utilisez la page [Statut de la synchronisation des flux de données](../optimizer/setup/data-sync.md) de l’interface utilisateur de Commerce Optimizer pour vérifier que les données ont bien été synchronisées avec Adobe Commerce Optimizer au lieu du tableau de bord de gestion des données.
