...
>[!NOTE]
>
>[Composants de dépôt](https://experienceleague.adobe.com/en/tools/commerce-storefront/dropins/all/introduction/) par [!DNL Commerce Storefront on Edge Delivery Services], récupérez automatiquement les dernières modifications apportées à GraphQL (nouveaux champs, limites et comportement des requêtes).
...
## Fonctionnalité expérimentale uniquement pour les sandbox ACCS {#accs-sandbox-experimental}

>[!IMPORTANT]
>
>Cette fonctionnalité est expérimentale et n’est disponible que dans les environnements Sandbox de [!DNL Adobe Commerce as a Cloud Service].
>
...
>[!NOTE]
>
>Lors de la connexion de [!DNL Adobe Commerce as a Cloud Service] à [!DNL AEM Assets], votre instance d’évaluation [!DNL AEM Assets] est mappée à votre instance de [!DNL Adobe Commerce as a Cloud Service] Sandbox et à tout autre environnement hors production. Votre instance de production [!DNL AEM Assets] est mappée à votre instance de production [!DNL Adobe Commerce as a Cloud Service].
