...
## Qui utilise [!DNL App Management] ?
...
* [Installer](install.md). Vérifiez que les conditions préalables sont remplies et que l’accès est [!DNL App Management].
* [Gérer l’application](manage-app.md). Associer, configurer et dissocier des applications.

## Pour les développeurs

Si vous créez des applications App Builder pour Adobe Commerce, consultez la documentation [Extensibilité de Commerce [!DNL App Management]](https://developer.adobe.com/commerce/extensibility/app-management/){target="_blank"} pour le schéma de configuration, les actions d’exécution et la configuration du développeur.
