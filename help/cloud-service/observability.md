...
[Proxy Real User Monitoring (RUM)](https://experienceleague.adobe.com/en/tools/commerce-storefront/setup/configuration/content-delivery-network/#proxy-rum-through-the-origin-to-avoid-a-tls-handshake) collecte de données via votre origine CDN pour éliminer une liaison TLS supplémentaire et améliorer la mesure des performances front-end.
