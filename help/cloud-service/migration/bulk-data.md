...
>[!IMPORTANT]
>
>Les paramètres de configuration ne sont pas importés automatiquement. Avant de commencer le processus de migration des données, notez les paramètres de configuration actuels du catalogue dans la [!DNL Commerce Admin]. Implémentez ensuite la même configuration dans l’environnement de [!DNL Adobe Commerce as a Cloud Service] cible.
