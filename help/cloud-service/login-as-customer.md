...
>[!IMPORTANT]
>
>Le code à usage unique généré en vente libre est valide pendant 30 secondes par défaut et est invalidé après une seule utilisation. La TTL peut être configurée via CPS à l’aide du paramètre `customer/otp/ttl_seconds`.
