...
* **Disponibilité des outils** : des outils dédiés à l’utilisation par les clients pour les migrations de données en masse Commerce propriétaires seront disponibles sur demande à la mi-juillet 2025. Si les clients ont besoin d’aide à la migration de données en bloc au préalable, Adobe peut faciliter le transfert de données en leur nom sur demande.
