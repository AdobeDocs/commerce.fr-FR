...
## Ajout d’un utilisateur à AEM Assets

La configuration suivante est requise pour les visualisations d’Adobe Experience Manager Assets et de produits optimisées par les utilisateurs d’AEM Assets.
