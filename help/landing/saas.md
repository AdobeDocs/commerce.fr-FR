...
Si vous n’êtes pas le propriétaire de la licence, vous devez obtenir les clés API Commerce de la personne ou de l’équipe qui détient la licence Commerce pour votre boutique.

>[!NOTE]
>
>Les clés API ne peuvent être générées que par le propriétaire de la licence. Il n’existe aucune fonctionnalité d’accès partagé pour permettre à d’autres utilisateurs de les générer.
...
| ---|--- |
| [[!DNL Product Recommendations]](/help/product-recommendations/overview.md) optimisé par l’IA dédiée à Adobe | Adobe Commerce |
| [[!DNL Live Search]](/help/live-search/overview.md) optimisé par l’IA dédiée à Adobe | Adobe Commerce |
