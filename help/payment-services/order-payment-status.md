...
1. Activez et planifiez la tâche cron `sync_order_payment_status` afin que les mises à jour de statut soient récupérées automatiquement. Voir [&#x200B; Configuration des tâches cron &#x200B;](https://experienceleague.adobe.com/en/docs/commerce-operations/configuration-guide/cli/configure-cron-jobs).
...
1. Affichez tous les litiges relatifs à une commande spécifique et consultez [statut du litige](#statuses-information).
...
1. Dans la barre latérale _Admin_, accédez à **[!UICONTROL Sales]** > **[!UICONTROL [!DNL Payment Services]]** > _[!UICONTROL Orders]_>**[!UICONTROL View Report]**.
1. Si vous souhaitez afficher les statuts pour une période autre que les 30 derniers jours, [personnalisez la période pour vos statuts](#customize-order-dates-timeframe).
