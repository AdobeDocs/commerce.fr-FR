...
En production, PayPal utilise la géolocalisation de l&#39;acheteur pour déterminer les méthodes de paiement disponibles dans les flux de paiement et d&#39;express. Comme le mode sandbox ne prend pas en charge la géolocalisation, utilisez la configuration **Pays de l’acheteur** pour simuler l’emplacement de l’acheteur et contrôler les modes de paiement rendus.

Ce paramètre est utile pour tester des méthodes de paiement spécifiques à une région, telles que Venmo (États-Unis uniquement), Payer plus tard (États-Unis et Royaume-Uni) ou [Méthodes de paiement locales](payments-options.md#local-payment-methods) (Europe), sans avoir besoin de VPN.

Pour configurer le pays de l&#39;acheteur :

1. Dans la barre latérale _Admin_, accédez à **[!UICONTROL Stores]** > _[!UICONTROL Settings]_>**[!UICONTROL Configuration]**.

1. Dans le panneau de gauche, développez **[!UICONTROL Sales]** et sélectionnez **[!UICONTROL Payment Methods]**.
...
1. Sélectionnez le pays souhaité dans le menu déroulant **[!UICONTROL Buyer's country]** .
