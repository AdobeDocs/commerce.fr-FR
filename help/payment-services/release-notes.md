...
![Nouveau](../assets/new.svg)<!-- Issue PAY-4050 --> Ajout d&#39;une [vue de visualisation des données](/help/payment-services/payouts.md#payouts-data-visualization-view), qui s&#39;affiche sur l&#39;Accueil du service de paiement, pour l&#39;état Statut du paiement des commandes.
...
![Nouveau](../assets/new.svg)<!-- Issue PAY-2761 --> Vous pouvez désormais personnaliser les données qui s&#39;affichent dans l&#39;état [Statut du paiement des commandes](/help/payment-services/order-payment-status.md#show-and-hide-columns) et l&#39;état [Paiements](/help/payment-services/payouts.md#show-and-hide-columns) en affichant ou en masquant les colonnes à l&#39;aide du contrôle Paramètres des colonnes.
...
![Nouveau](../assets/new.svg)<!-- PAY-6227 --> lors de la commande avec PayPal, [!DNL Payment Services] ignore le pop-up de confirmation de commande pour accélérer le processus d&#39;achat. Cette fonction est activée par le [rappel d&#39;expédition côté serveur](payments-options.md#server-side-shipping-callback), qui calcule l&#39;expédition et les totaux directement dans la page de vérification PayPal.
...
![Nouveau](../assets/new.svg)<!-- PAY-4868 --> les commerçants peuvent [configurer Google Pay tout au long de l’expérience d’achat](/help/payment-services/payments-options.md) comme les autres boutons de paiement dans [!DNL Payment Services] via l’administrateur.
...
![Nouveau](../assets/new.svg)<!-- Issue xxx --> Ajoutée [disponibilité dans les pays suivants et les devises associées](introduction.md#availability) : Australie, France, Royaume-Uni.
