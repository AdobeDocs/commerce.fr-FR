...
| Génération, rotation et révocation de [clés d’accès restreintes](setup/restricted-access-keys.md) et jetons de signature pour les [!UICONTROL Catalog Protection] | | RA |
