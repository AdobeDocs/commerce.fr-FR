...
- Améliorez la pertinence de la découverte de produits avec un classement qui donne la priorité aux **correspondances exactes et proches** et aux correspondances de même champ. Voir [Correspondance de recherche et classement](./manage-results/search-relevance-matching.md).
...
- **Vues de catalogue privé** - Restreignez une vue de catalogue afin que seules les requêtes portant un jeton signé valide puissent récupérer ses données. Voir [Vues de catalogue privé](setup/private-catalog-view.md) pour la configuration.
